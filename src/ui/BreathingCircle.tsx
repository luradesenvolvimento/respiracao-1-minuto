...
export function BreathingCircle({
  ...
  return (
    <View style={styles.circleContainer}>
      <Animated.View
        style={[styles.circleOuter, { transform: [ { rotate: rotateInterpolation }, { scale: circleScale } ] }]}
      >
        <LinearGradient
        ...
        >
          <Animated.View
            style={[styles.circleInner, { transform: [{ rotate: rotateInverseInterpolation }] }]}
          >
